 ...
 */
case class Select(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[tree.Node] = Seq.empty) extends HTMLTag[Select] {
...
<code>autofocus</code> attribute, which is a Boolean.
  ...
  def autofocus(value: String): Select = copy(attributes = attributes + ("autofocus" -> value.toString)).asInstanceOf[Select]
  /**
...
<code>disabled</code> attribute set, then the control is enabled.
  ...
  def disabled(value: String): Select = copy(attributes = attributes + ("disabled" -> value.toString)).asInstanceOf[Select]
  /**
  ...
  def form(value: String): Select = copy(attributes = attributes + ("form" -> value.toString)).asInstanceOf[Select]
  /**
  ...
  def multiple(value: String): Select = copy(attributes = attributes + ("multiple" -> value.toString)).asInstanceOf[Select]
  /**
   * The name of the control.
   */
  def name: scala.Option[String] = attributes.get("name").asInstanceOf[scala.Option[String]]
  def name(value: String): Select = copy(attributes = attributes + ("name" -> value.toString)).asInstanceOf[Select]
  /**
   * A Boolean attribute indicating that an option with a non-empty string value must be selected.
   */
  def required: scala.Option[String] = attributes.get("required").asInstanceOf[scala.Option[String]]
  def required(value: String): Select = copy(attributes = attributes + ("required" -> value.toString)).asInstanceOf[Select]
  /**
  ...
  def size(value: String): Select = copy(attributes = attributes + ("size" -> value.toString)).asInstanceOf[Select]
}
