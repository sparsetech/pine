 ...
 */
case class Thead(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[tree.Node] = Seq.empty) extends HTMLTag[Thead] {
...
<div class="note"> 
 ...
 <ul> 
  ...
  def align(value: String): Thead = copy(attributes = attributes + ("align" -> value.toString)).asInstanceOf[Thead]
  /**
...
<div class="note"> 
 ...
 <a href="/en-US/docs/Web/HTML/Element/th" title="Editorial review completed."><code>&lt;th&gt;</code></a> elements.
  ...
  def bgcolor(value: String): Thead = copy(attributes = attributes + ("bgcolor" -> value.toString)).asInstanceOf[Thead]
  /**
...
<div class="note"> 
 ...
 <span class="inlineIndicator unimplemented unimplementedInline">Unimplemented</span>.
  ...
  def char(value: String): Thead = copy(attributes = attributes + ("char" -> value.toString)).asInstanceOf[Thead]
  /**
...
<div class="note"> 
 <strong>Note: </strong>Do not use this attribute as it is obsolete (and not supported) in the latest standard.
  ...
  def charoff(value: String): Thead = copy(attributes = attributes + ("charoff" -> value.toString)).asInstanceOf[Thead]
  /**
...
<div class="note"> 
 ...
 <a href="/en-US/docs/Web/CSS/vertical-align" title="The vertical-align CSS property specifies the vertical alignment of an inline or table-cell box."><code>vertical-align</code></a> property on it.
  ...
  def valign(value: String): Thead = copy(attributes = attributes + ("valign" -> value.toString)).asInstanceOf[Thead]
}
