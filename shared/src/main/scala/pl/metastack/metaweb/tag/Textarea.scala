 ...
 */
case class Textarea(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[tree.Node] = Seq.empty) extends HTMLTag[Textarea] {
  override def tagName = "textarea"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[tree.Node] = children): Textarea = Textarea(attributes, children)
  /**
...
<ul> 
 ...
 <li><code>off</code>: <span title="This deprecated API should no longer be used, but will probably still work."><i class="icon-thumbs-down-alt"> </i></span> Deprecated since iOS 5.</li> 
  ...
  def autocapitalize(value: String): Textarea = copy(attributes = attributes + ("autocapitalize" -> value.toString)).asInstanceOf[Textarea]
  /**
...
<p>If the <strong>autocomplete</strong> attribute is not specified on an textarea element, then the browser uses the <strong>autocomplete</strong> attribute value of the <code>&lt;textarea&gt;</code> element's form owner. The form owner is either the <code>form</code> element that this <code>&lt;textarea&gt;</code> element is a descendant of or the form element whose <strong>id</strong> is specified by the <strong>form</strong> attribute of the input element. For more information, see the <code><a href="/en-US/docs/Web/HTML/Element/form#attr-autocomplete">autocomplete</a></code> attribute in <a href="/en-US/docs/Web/HTML/Element/form" title="The HTML <form> element represents a document section that contains interactive controls to submit information to a web server."><code>&lt;form&gt;</code></a>.</p>
  ...
  def autocomplete(value: String): Textarea = copy(attributes = attributes + ("autocomplete" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def autofocus(value: String): Textarea = copy(attributes = attributes + ("autofocus" -> value.toString)).asInstanceOf[Textarea]
  /**
...
<span style="font-family: courier new;">20</span> (HTML5).
  ...
  def cols(value: String): Textarea = copy(attributes = attributes + ("cols" -> value.toString)).asInstanceOf[Textarea]
  /**
...
<code>disabled</code> attribute set, then the control is enabled.)
  ...
  def disabled(value: String): Textarea = copy(attributes = attributes + ("disabled" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def form(value: String): Textarea = copy(attributes = attributes + ("form" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def maxlength(value: String): Textarea = copy(attributes = attributes + ("maxlength" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def minlength(value: String): Textarea = copy(attributes = attributes + ("minlength" -> value.toString)).asInstanceOf[Textarea]
  /**
   * The name of the control.
   */
  def name: scala.Option[String] = attributes.get("name").asInstanceOf[scala.Option[String]]
  def name(value: String): Textarea = copy(attributes = attributes + ("name" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def placeholder(value: String): Textarea = copy(attributes = attributes + ("placeholder" -> value.toString)).asInstanceOf[Textarea]
  /**
...
<code>readonly</code> attribute does not prevent the user from clicking or selecting in the control. The value of a read-only control is still submitted with the form.
  ...
  def readonly(value: String): Textarea = copy(attributes = attributes + ("readonly" -> value.toString)).asInstanceOf[Textarea]
  /**
   * This attribute specifies that the user must fill in a value before submitting a form.
   */
  def required: scala.Option[String] = attributes.get("required").asInstanceOf[scala.Option[String]]
  def required(value: String): Textarea = copy(attributes = attributes + ("required" -> value.toString)).asInstanceOf[Textarea]
  /**
   * The number of visible text lines for the control.
   */
  def rows: scala.Option[String] = attributes.get("rows").asInstanceOf[scala.Option[String]]
  def rows(value: String): Textarea = copy(attributes = attributes + ("rows" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def selectionDirection(value: String): Textarea = copy(attributes = attributes + ("selectionDirection" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def selectionEnd(value: String): Textarea = copy(attributes = attributes + ("selectionEnd" -> value.toString)).asInstanceOf[Textarea]
  /**
  ...
  def selectionStart(value: String): Textarea = copy(attributes = attributes + ("selectionStart" -> value.toString)).asInstanceOf[Textarea]
  /**
...
<p>If this attribute is not specified, <span style="font-family: courier new;">soft</span> is its default value.</p>
  ...
  def wrap(value: String): Textarea = copy(attributes = attributes + ("wrap" -> value.toString)).asInstanceOf[Textarea]
}
