 ...
 */
case class Br(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[Node] = Seq.empty) extends HTMLTag {
  override type T = Br
  override def tagName = "br"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[Node] = children): Br = Br(attributes, children)
  /**
...
<div class="note"> 
 <p><strong>Usage note: </strong>This attribute is obsolete in <span class="inlineIndicator htmlVer htmlVerInline"><a href="/en-US/docs/HTML/HTML5">HTML5</a></span> and <strong>should not be used by authors</strong>. Use the CSS <a href="/en-US/docs/Web/CSS/clear"><code>clear</code></a> property instead.</p> 
  ...
  def clear(value: String): Br = copy(attributes = attributes + ("clear" -> value))
}
