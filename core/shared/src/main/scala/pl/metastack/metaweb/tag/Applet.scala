...
<strong>texttop</strong>.
  ...
  def align(value: String): Applet = copy(attributes = attributes + ("align" -> value))
  /**
...
<code>&lt;applet&gt;</code> element may also be rendered as alternative text.
  ...
  def alt(value: String): Applet = copy(attributes = attributes + ("alt" -> value))
  /**
  ...
  def archive(value: String): Applet = copy(attributes = attributes + ("archive" -> value))
  /**
...
<code>codebase</code> attribute.
  ...
  def code(value: String): Applet = copy(attributes = attributes + ("code" -> value))
  /**
   * This attribute gives the absolute or relative URL of the directory where applets' .class files referenced by the code attribute are stored.
   */
  def codebase: scala.Option[String] = attributes.get("codebase").asInstanceOf[scala.Option[String]]
  def codebase(value: String): Applet = copy(attributes = attributes + ("codebase" -> value))
  /**
...
<a href="/en-US/docs/Web/HTML/Element/param" title="The HTML <param> Element (or HTML Parameter Element) defines parameters for <object>."><code>&lt;param&gt;</code></a> elements passed to the Java applet.
  ...
  def datafld(value: String): Applet = copy(attributes = attributes + ("datafld" -> value))
  /**
   * Like 
...
<a href="/en-US/docs/Web/HTML/Element/param" title="The HTML <param> Element (or HTML Parameter Element) defines parameters for <object>."><code>&lt;param&gt;</code></a> elements associated with the applet.
  ...
  def datasrc(value: String): Applet = copy(attributes = attributes + ("datasrc" -> value))
  /**
  ...
  def height(value: String): Applet = copy(attributes = attributes + ("height" -> value))
  /**
  ...
  def hspace(value: String): Applet = copy(attributes = attributes + ("hspace" -> value))
  /**
  ...
  def mayscript(value: String): Applet = copy(attributes = attributes + ("mayscript" -> value))
  /**
  ...
  def name(value: String): Applet = copy(attributes = attributes + ("name" -> value))
  /**
  ...
  def `object`(value: String): Applet = copy(attributes = attributes + ("object" -> value))
  /**
  ...
  def src(value: String): Applet = copy(attributes = attributes + ("src" -> value))
  /**
  ...
  def vspace(value: String): Applet = copy(attributes = attributes + ("vspace" -> value))
  /**
  ...
  def width(value: String): Applet = copy(attributes = attributes + ("width" -> value))
}
