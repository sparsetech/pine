...
trait Attributes {
  ...
  implicit class TagRefAttributesBody(tagRef: TagRef[tag.Body]) {
    ...
    val onafterprint = TagRefAttribute[tag.Body, String](tagRef, "onafterprint")
    val onbeforeprint = TagRefAttribute[tag.Body, String](tagRef, "onbeforeprint")
    val onbeforeunload = TagRefAttribute[tag.Body, String](tagRef, "onbeforeunload")
    val onblur = TagRefAttribute[tag.Body, String](tagRef, "onblur")
    val onerror = TagRefAttribute[tag.Body, String](tagRef, "onerror")
    val onfocus = TagRefAttribute[tag.Body, String](tagRef, "onfocus")
    val onhashchange = TagRefAttribute[tag.Body, String](tagRef, "onhashchange")
    val onlanguagechange = TagRefAttribute[tag.Body, String](tagRef, "onlanguagechange")
    val onload = TagRefAttribute[tag.Body, String](tagRef, "onload")
    val onmessage = TagRefAttribute[tag.Body, String](tagRef, "onmessage")
    val onoffline = TagRefAttribute[tag.Body, String](tagRef, "onoffline")
    val ononline = TagRefAttribute[tag.Body, String](tagRef, "ononline")
    val onpopstate = TagRefAttribute[tag.Body, String](tagRef, "onpopstate")
    val onredo = TagRefAttribute[tag.Body, String](tagRef, "onredo")
    val onresize = TagRefAttribute[tag.Body, String](tagRef, "onresize")
    val onstorage = TagRefAttribute[tag.Body, String](tagRef, "onstorage")
    val onundo = TagRefAttribute[tag.Body, String](tagRef, "onundo")
    val onunload = TagRefAttribute[tag.Body, String](tagRef, "onunload")
