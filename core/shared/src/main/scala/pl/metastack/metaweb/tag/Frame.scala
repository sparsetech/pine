 ...
 */
case class Frame(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[Node] = Seq.empty) extends HTMLTag {
  override type T = Frame
  override def tagName = "frame"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[Node] = children): Frame = Frame(attributes, children)
  /**
  ...
  def src(value: String): Frame = copy(attributes = attributes + ("src" -> value))
  /**
  ...
  def name(value: String): Frame = copy(attributes = attributes + ("name" -> value))
  /**
  ...
  def noresize(value: String): Frame = copy(attributes = attributes + ("noresize" -> value))
  /**
  ...
  def scrolling(value: String): Frame = copy(attributes = attributes + ("scrolling" -> value))
  /**
  ...
  def marginheight(value: String): Frame = copy(attributes = attributes + ("marginheight" -> value))
  /**
  ...
  def marginwidth(value: String): Frame = copy(attributes = attributes + ("marginwidth" -> value))
  /**
  ...
  def frameborder(value: String): Frame = copy(attributes = attributes + ("frameborder" -> value))
}
