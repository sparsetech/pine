...
<body>
  ...
  test("Instantiate template") {
    ...
    val listItem = tpl.byId[Tag]("list-item")
  ...
  test("Bind list item from template") {
    ...
    val listItem = tpl.byId[Tag]("list-item").withoutId
    ...
    val replaced = tpl.updateById[Tag]("list", _.set(items))
      .asInstanceOf[Tag]

    val list = replaced.byId[Tag]("list")
