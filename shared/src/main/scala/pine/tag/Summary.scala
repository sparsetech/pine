 ...
 */
case class Summary(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[Node] = Seq.empty) extends HTMLTag {
  override type T = Summary
  override def tagName = "summary"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[Node] = children): Summary = Summary(attributes, children)
}
