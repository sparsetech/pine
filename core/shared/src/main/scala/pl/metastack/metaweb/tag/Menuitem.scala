 ...
 */
case class Menuitem(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[Node] = Seq.empty) extends HTMLTag {
  override type T = Menuitem
  override def tagName = "menuitem"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[Node] = children): Menuitem = Menuitem(attributes, children)
  /**
