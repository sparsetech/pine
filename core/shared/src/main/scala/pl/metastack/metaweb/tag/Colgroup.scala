...
<div class="note">
 ...
 <ul> 
  ...
  def align(value: String): Colgroup = copy(attributes = attributes + ("align" -> value))
  /**
...
<div class="note">
 ...
 <a href="/en-US/docs/Web/HTML/Element/td" title="The Table cell HTML element (<td>) defines a cell of a table that contains data. It participates in the table model."><code>&lt;td&gt;</code></a> elements.
  ...
  def bgcolor(value: String): Colgroup = copy(attributes = attributes + ("bgcolor" -> value))
  /**
...
<div class="note">
 ...
 <span class="inlineIndicator unimplemented unimplementedInline">Unimplemented</span>.
  ...
  def char(value: String): Colgroup = copy(attributes = attributes + ("char" -> value))
  /**
...
<div class="note">
 <strong>Note: </strong>Do not use this attribute as it is obsolete (and not supported) in the latest standard.
  ...
  def charoff(value: String): Colgroup = copy(attributes = attributes + ("charoff" -> value))
  /**
...
<div class="note">
 ...
 <ul> 
  ...
  def span(value: Long): Colgroup = copy(attributes = attributes + ("span" -> value))
  /**
...
<div class="note">
 ...
 <ul> 
  ...
  def valign(value: String): Colgroup = copy(attributes = attributes + ("valign" -> value))
  /**
...
<code>0.5*</code> also can be used.
  ...
  def width(value: String): Colgroup = copy(attributes = attributes + ("width" -> value))
}
