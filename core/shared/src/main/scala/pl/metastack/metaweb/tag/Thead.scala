 ...
 */
case class Thead(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[Node] = Seq.empty) extends HTMLTag {
  override type T = Thead
  override def tagName = "thead"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[Node] = children): Thead = Thead(attributes, children)
  /**
...
<div class="note"> 
 ...
 <ul> 
  ...
  def align(value: String): Thead = copy(attributes = attributes + ("align" -> value))
  /**
...
<div class="note"> 
 ...
 <a href="/en-US/docs/Web/HTML/Element/th" title="Editorial review completed."><code>&lt;th&gt;</code></a> elements.
  ...
  def bgcolor(value: String): Thead = copy(attributes = attributes + ("bgcolor" -> value))
  /**
...
<div class="note"> 
 ...
 <span class="inlineIndicator unimplemented unimplementedInline">Unimplemented</span>.
  ...
  def char(value: String): Thead = copy(attributes = attributes + ("char" -> value))
  /**
...
<div class="note"> 
 <strong>Note: </strong>Do not use this attribute as it is obsolete (and not supported) in the latest standard.
  ...
  def charoff(value: String): Thead = copy(attributes = attributes + ("charoff" -> value))
  /**
...
<div class="note"> 
 ...
 <a href="/en-US/docs/Web/CSS/vertical-align" title="The vertical-align CSS property specifies the vertical alignment of an inline or table-cell box."><code>vertical-align</code></a> property on it.
  ...
  def valign(value: String): Thead = copy(attributes = attributes + ("valign" -> value))
}
