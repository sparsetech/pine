 ...
 */
case class Dir(attributes: Predef.Map[String, Any] = Predef.Map.empty, children: Seq[Node] = Seq.empty) extends HTMLTag {
  override type T = Dir
  override def tagName = "dir"
  override def copy(attributes: Predef.Map[String, Any] = attributes, children: Seq[Node] = children): Dir = Dir(attributes, children)
  /**
